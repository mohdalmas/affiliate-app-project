...
export function SignUpUserSteps() {
  return (
    <ol className="flex flex-col gap-6">
      ...
      <TutorialStep title="Create your admin account">
        <p>
          This app has a single admin (you) — there&apos;s no public sign-up
          form. Create your account in the Supabase dashboard under{" "}
